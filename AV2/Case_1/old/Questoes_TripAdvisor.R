...
#plot(trip[c("Category 2", "Category 7")],col = kmeans.result$cluster)
#points(kmeans.result$centers[,c("Category 2", "Category 7")], col=1:3, pch=8, cex=2)
...
#points(kmeans.result$centers[,c("Category 2","Category 7")], col=1:3, pch=8, cex=2)
#points(kmeans.result$centers[,c("Category 7", "Category 2")], col=1:3, pch=8, cex=2)
...
# hist(trip$`Category 1`, col = kmeans.result$cluster)
...
#   Fundamente suas decisões, não se prenda ao algoritmo visto em sala,
# porém apenas algoritmos de clusterização serão aceitos. Documente seu
# processo de análise em um documento que será entregue à agência.